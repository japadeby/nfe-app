...
module.constant('config', {
  // serverUrlBase: 'http://10.0.1.6:3000',
  // serverUrlBase: 'http://192.168.159.108:3000',
  // serverUrlBase: 'http://192.168.100.103:3000',
  serverUrlBase: 'http://localhost:3000',
});

module.config(function (LoopBackResourceProvider) {
  // console.log(angular.module('lbServices').constant('config'));
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Nfe.customer() instead.
        "prototype$__get__customer": {
          url: urlBase + "/nfes/:id/customer",
          method: "GET"
        },
        ...
        // INTERNAL. Use Customer.nfes.findById() instead.
        "::findById::Customer::nfes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/nfes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.nfes.destroyById() instead.
        "::destroyById::Customer::nfes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/nfes/:fk",
        ...
        // INTERNAL. Use Customer.nfes.updateById() instead.
        "::updateById::Customer::nfes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/nfes/:fk",
        ...
        // INTERNAL. Use Customer.nfes() instead.
        "::get::Customer::nfes": {
          isArray: true,
          url: urlBase + "/Customers/:id/nfes",
          method: "GET"
        },

        // INTERNAL. Use Customer.nfes.create() instead.
        "::create::Customer::nfes": {
          url: urlBase + "/Customers/:id/nfes",
          method: "POST"
        },

        // INTERNAL. Use Customer.nfes.createMany() instead.
        "::createMany::Customer::nfes": {
          isArray: true,
          url: urlBase + "/Customers/:id/nfes",
          method: "POST"
        },

        // INTERNAL. Use Customer.nfes.destroyAll() instead.
        "::delete::Customer::nfes": {
          url: urlBase + "/Customers/:id/nfes",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.nfes.count() instead.
        "::count::Customer::nfes": {
          url: urlBase + "/Customers/:id/nfes/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Nfe";
        ...
        R.customer = function() {
          ...
          var action = TargetResource["::get::nfe::customer"];
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.nfes.create() instead.
        "prototype$__create__nfes": {
          url: urlBase + "/Customers/:id/nfes",
          method: "POST"
        },

        // INTERNAL. Use Customer.nfes.destroyAll() instead.
        "prototype$__delete__nfes": {
          url: urlBase + "/Customers/:id/nfes",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.nfes.count() instead.
        "prototype$__count__nfes": {
          url: urlBase + "/Customers/:id/nfes/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.nfes
     * @header lbServices.Customer.nfes
     * @object
     * @description
     *
     * The object `Customer.nfes` groups methods
     * manipulating `Nfe` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#nfes Customer.nfes()}
     ...
     */
         ...
         */
        R.nfes = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::get::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#count
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Counts nfes of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` -
         */
        R.nfes.count = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::count::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#create
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Creates a new instance in nfes of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.nfes.create = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::create::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#createMany
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         ...
         * </em>
         */
        R.nfes.createMany = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::createMany::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#destroyAll
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Deletes all nfes of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.nfes.destroyAll = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::delete::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#destroyById
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Delete a related item by id for nfes.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for nfes
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.nfes.destroyById = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::destroyById::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#findById
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Find a related item by id for nfes.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.nfes.findById = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::findById::Customer::nfes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.nfes#updateById
         * @methodOf lbServices.Customer.nfes
         *
         * @description
         *
         * Update a related item by id for nfes.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.nfes.updateById = function() {
          var TargetResource = $injector.get("Nfe");
          var action = TargetResource["::updateById::Customer::nfes"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Cnae
 * @header lbServices.Cnae
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Cnae` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#create
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Cnae` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/cnaes",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#createMany
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/cnaes/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Cnae#findById
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/cnaes/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Cnae#find
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/cnaes/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Cnae#updateAll
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/cnaes/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Cnae#deleteById
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/cnaes/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Cnae#prototype$updateAttributes
         * @methodOf lbServices.Cnae
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#createChangeStream
         * @methodOf lbServices.Cnae
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/cnaes/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#updateOrCreate
         * @methodOf lbServices.Cnae
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#destroyById
         * @methodOf lbServices.Cnae
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cnae#removeById
         * @methodOf lbServices.Cnae
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Cnae#modelName
    * @propertyOf lbServices.Cnae
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Cnae`.
    */
